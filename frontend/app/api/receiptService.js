const RECEIPT_API_URL = process.env.NEXT_PUBLIC_RECEIPT_API_URL || "http://localhost:8084/api";
const INVENTORY_API_URL = process.env.NEXT_PUBLIC_INVENTORY_API_URL || "http://localhost:8082/api";
